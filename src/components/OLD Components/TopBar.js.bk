...
function TopBar() {
  const [selectedLanguage, setSelectedLanguage] = useState('EN'); // Αρχική γλώσσα: EN
      ...
      <div className="wrap-top-bar">
        ...
        <div className="top-logo">
          <a href="/" className="site-logo">
            <img alt="Anageno Logo" src="/images/logo/logo@2x.png" />
          </a>
        </div>
            ...
            <li>
              <div className="tf-dropdown-sort tf-languages" data-bs-toggle="dropdown">
                <div className="btn-select">
                  <span className="text-sort-value">{selectedLanguage}</span>
                  <i className="icon-CaretDown"></i>
                </div>
                <div className="dropdown-menu">
                  <div
                    className={`select-item ${selectedLanguage === 'EN' ? 'active' : ''}`}
                    onClick={() => handleLanguageChange('EN')}
                  >
                    <span className="text-value-item">EN</span>
                  </div>
                  <div
                    className={`select-item ${selectedLanguage === 'UA' ? 'active' : ''}`}
                    onClick={() => handleLanguageChange('UA')}
                  >
                    <span className="text-value-item">UA</span>
                  </div>
                  <div
                    className={`select-item ${selectedLanguage === 'RU' ? 'active' : ''}`}
                    onClick={() => handleLanguageChange('RU')}
                  >
                    <span className="text-value-item">RU</span>
                  </div>
                </div>
              </div>
            </li>
