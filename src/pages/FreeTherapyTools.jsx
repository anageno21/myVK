...
const FreeTherapyTools = () => {
  return (
    <div className="free-therapy-tools">
      <ProfileHeader />
      ...
      {/* Ενότητα "Наш Подход: Пошаговый План Прогресса" */}
      <section className="services-section method-section">
        <div className="container">
          <div className="services-header">
            <span className="sub-title">Наш Подход</span>
          ...
          <div className="services-grid">
            <div className="progress-grid">
              ...
              <div className="progress-step">
                ...
                <h6>Шаг 5: Начни путь к изменениям</h6>
...
export default FreeTherapyTools;