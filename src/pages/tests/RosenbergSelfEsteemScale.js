      ...
      <div className="free-package-section">
        <div className="section-content">
          ...
          <p className="section-description">
            Насколько ты уверен(а) в себе — и как это влияет на твои решения, отношения и эмоциональное состояние? Шкала самооценки Розенберга — один из самых широко используемых и валидированных психологических тестов в мире. Она оценивает общее чувство собственного достоинства и отношение человека к самому себе.
            Самооценка влияет на всё: от выбора партнёра и карьерных шагов до способности справляться с критикой и стрессом. Пройди тест — и получи релевантные рекомендации, с чего начать укрепление своей самооценки и внутренней опоры.
                ...
                {result ? (
                  <div className="test-result">
                    ...
                    <div className="score-bar">
                      ...
                      ></div>
                      <span className="score-label" style={{ position: 'absolute', left: `${(result.score / 30) * 100}%`, transform: 'translateX(-50%)' }}>
                        {result.score}
                      </span>
                    </div>
