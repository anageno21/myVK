...
function RRS() {
  ...
  const calculateResult = () => {
    ...
    } else { // 3-4 μέсος όρος (22 ερωτήσεις x 4 = 88)
      recommendation = {
                ...
                {result ? (
                  <div className="test-result">
                    ...
                    <div className="score-bar">
                      ...
                      ></div>
                      <span className="score-label" style={{ position: 'absolute', left: `${((result.score - 22) / 66) * 100}%`, transform: 'translateX(-50%)' }}>
                        {result.score}
                      </span>
                    </div>
                    ...
                    <div className="subscale-chart">
                      <div className="bar-container">
                        <span className="bar-label">Само-фокусировка</span>
                        <div className="bar">
                          <div
                            className="bar-fill"
                            style={{
                          ...
                          ></div>
                          <span className="bar-value">{result.scores.SelfFocus || 0}</span>
                        </div>
                      </div>
                      <div className="bar-container">
                        <span className="bar-label">Фокусировка на симптомах</span>
                        <div className="bar">
                          <div
                            className="bar-fill"
                            style={{
                          ...
                          ></div>
                          <span className="bar-value">{result.scores.SymptomFocus || 0}</span>
                        </div>
                      </div>
                      <div className="bar-container">
                        <span className="bar-label">Фокусировка на причинах/последствиях</span>
                        <div className="bar">
                          <div
                            className="bar-fill"
                            style={{
                          ...
                          ></div>
                          <span className="bar-value">{result.scores.CausesConsequences || 0}</span>
                        </div>
                      </div>
                    </div>
