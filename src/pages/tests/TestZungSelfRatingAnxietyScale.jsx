...
function TestZungSelfRatingAnxietyScale() {
            ...
            {result ? (
              <div className="test-result">
                ...
                <div className="score-bar">
                  <div
                    className={`score-progress ${result.score <= 35 ? 'score-progress-top' : result.score <= 50 ? 'score-progress-medium' : 'score-progress-low'}`}
                    style={{ width: `${((result.score - 20) / 60) * 100}%` }}
                  ></div>
                  <span className="score-label" style={{ left: `${((result.score - 20) / 60) * 100}%` }}>
                    {result.score}
                  </span>
                </div>
...
export default TestZungSelfRatingAnxietyScale;