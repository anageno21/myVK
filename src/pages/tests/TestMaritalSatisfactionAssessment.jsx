...
function TestMaritalSatisfactionAssessment() {
  ...
  const questions = [
    {
      id: 'q1',
      text: 'Я доволен тем, как мы с партнером разделяем обязанности.',
      options: [
    ...
    {
      id: 'q2',
      text: 'Мы с партнером часто ссоримся из-за финансов.',
      options: [
    ...
    {
      id: 'q3',
      text: 'Я чувствую, что мой партнер поддерживает меня в трудные моменты.',
      options: [
        { value: '0', text: 'Совсем не верно' },
        { value: '1', text: '1' },
        { value: '2', text: '2' },
    ...
    {
      id: 'q4',
      text: 'Мы с партнером редко проводим время вместе.',
      options: [
        { value: '7', text: 'Совсем не верно' },
        { value: '6', text: '1' },
        { value: '5', text: '2' },
    ...
    {
      id: 'q6',
      text: 'Я чувствую, что мы с партнером разделяем общие ценности.',
      options: [
        { value: '0', text: 'Совсем не верно' },
        { value: '1', text: '1' },
        { value: '2', text: '2' },
    ...
    {
      id: 'q7',
      text: 'Я часто чувствую себя непонятым в браке.',
      options: [
        { value: '7', text: 'Совсем не верно' },
        { value: '6', text: '1' },
        { value: '5', text: '2' },
    ...
    {
      id: 'q8',
      text: 'Мы с партнером хорошо общаемся.',
      options: [
        { value: '0', text: 'Совсем не верно' },
        { value: '1', text: '1' },
        { value: '2', text: '2' },
    ...
    {
      id: 'q10',
      text: 'Я чувствую, что наш брак приносит мне счастье.',
      options: [
        { value: '0', text: 'Совсем не верно' },
        { value: '1', text: '1' },
        { value: '2', text: '2' },
  ...
  const calculateResult = () => {
    ...
    if (totalScore <= 35) {
      recommendation = {
        ...
        description: 'Твой уровень удовлетворенности браком может быть низким. Наш расширенный пакет поможет вам работать над улучшением отношений.',
      };
      ...
      recommendation = {
        ...
        packageLink: '/our-service',
        description: 'Твой уровень удовлетворенности браком находится на среднем уровне. Наш базовый пакет поможет укрепить ваши отношения.',
      };
    } else {
      recommendation = {
        ...
        description: 'У тебя высокий уровень удовлетворенности браком! Наш бесплатный вводный пакет поможет вам продолжать развивать гармонию.',
      };
    }
  ...
  const shareViaEmail = () => {
    if (!result) return;
    const subject = 'Мои результаты теста: Оценка удовлетворенности браком';
  ...
  const shareViaWhatsApp = () => {
    if (!result) return;
    const text = `Мои результаты теста: Оценка удовлетворенности браком\nТвой балл: ${result.score} из 70\nУровень: ${result.recommendation.level}\nРекомендация: ${result.recommendation.description}\nПредлагаемый пакет: ${result.recommendation.package}`;
  ...
  const printResult = () => {
    if (!result) return;
    const printContent = `
      <h3>Результаты теста: Оценка удовлетворенности браком</h3>
      ...
      <div className="free-package-section">
        <div className="section-content">
          <h3 className="section-title">
            Оценка удовлетворенности браком
          </h3>
          <p className="section-description">
            Этот тест помогает оценить уровень удовлетворенности твоим браком — от общения до разделения обязанностей. Пройди тест — и получи рекомендации, которые помогут улучшить ваш брак.
...
export default TestMaritalSatisfactionAssessment;