          ...
          <div className="layout-wrapper">
            ...
            <div className="sidebar-section">
              <div className="cta-block">
                <h3>Начните улучшать свои отношения</h3>
                <Link to="/our-service" className="cta-button">
                  Выберите подходящий пакет
                </Link>
              </div>
              <div className="cta-block">
                <h3>Попробуйте бесплатно!</h3>
                <p>Получите доступ к базовым материалам на 3 дня с нашим бесплатным пакетом.</p>
